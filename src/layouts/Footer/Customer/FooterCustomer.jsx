			...
			<div className='footer--wrapper'>
				<div className='wrapper--box'>
					...
					<div className='box__item'>
						...
						<Typography className='item__text'>+84 - 982 - 004 - 055</Typography>
					</div>

					<div className='box__item'>
						<img src={AssetImages.ICONS.PHONE} alt='' />
						<Typography className='item__text'>+84 - 907 - 625 - 917</Typography>
					</div>

					<div className='box__item'>
						<img src={AssetImages.ICONS.PHONE} alt='' />
						<Typography className='item__text'>+84 - 386 - 040 - 060</Typography>
					</div>
					...
					<div className='box__item'>
						...
						<Typography className='item__text'>FPT University, Ninh Kieu, Can Tho</Typography>
					</div>
				</div>
				...
				<div className='wrapper--box'>
					...
					{/* <div className='box__qr-code'>
						<img src={AssetImages.QRCODE} alt='' style={{ width: '222.8px', height: '226.8px' }} />

						<div className='box__download'>
							<img src={AssetImages.CHPLAY} alt='' style={{ width: '150px', height: 'auto' }} />

							<img src={AssetImages.APPSTORE} alt='' style={{ width: '150px', height: 'auto' }} />

							<Typography className='item__text'>Scan the QR code to download the application</Typography>
						</div>
					</div> */}
				</div>
			</div>
